<?php
    ...
    echo "<br>";
    echo "¿miEquipo es instancia de IEquipoFutbol?";
    var_dump($miEquipo instanceof IEquipoFutbol);
    echo "<br>";
    echo "¿miEquipo es instancia de ICampeonato?";
    var_dump($miEquipo instanceof ICampeonato);